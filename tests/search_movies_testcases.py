...
class SearchMoviesTestcases(unittest.TestCase):
    def get_user_positive_test_one(self):
        ...
        actual_val = response_json['user'][0]['phone']
    ...
    def get_user_negative_test_one(self):
        general_obj = SearchMovies()
        status_code, response_json = general_obj.get_user(url_list_of_cities, {'user_id': "abc"},
                                                          headers_with_apikey)
        print(status_code)
    ...
    def get_user_negative_test_two(self):
        general_obj = SearchMovies()
        status_code, response_json = general_obj.get_user(url_list_of_cities, {'user_id': "12abc"},
                                                          headers_with_apikey)
        print(status_code)
        self.assertEqual(status_code, 400)
        print(str(response_json))
    ...
    def get_user_negative_test_three(self):
        general_obj = SearchMovies()
        status_code, response_json = general_obj.get_user(url_list_of_cities, {'user_id': None},
                                                          headers_with_apikey)
        print(status_code)
        self.assertEqual(status_code, 400)
        print(str(response_json))
    ...
    def post_add_new_user_positive_test_one(self):
        general_obj = SearchMovies()
        status_code, response_json = general_obj.post_user(url_list_of_cities,
        ...
        print(str(response_json))
        actual_val = response_json['message']
        self.assertEqual(str(actual_val), "Successfully added the user to the database",
                         "ERR: Failed to post the appropriate user")

    def post_add_new_user_negative_test_one(self):
        general_obj = SearchMovies()
        status_code, response_json = general_obj.post_user(url_list_of_cities, {'user_id': "abc"},
                                                           headers_with_apikey)
        print(status_code)
        self.assertEqual(status_code, 400)
        print(str(response_json))
    ...
    def post_add_new_user_negative_test_two(self):
        general_obj = SearchMovies()
        status_code, response_json = general_obj.post_user(url_list_of_cities,
                                                           {'first_name': None, 'second_name': 'Austen',
                                                            "email": "jane.austen@gmail.com", "phone": 2380942358},
                                                           headers_with_apikey)
        print(status_code)
        self.assertEqual(status_code, 400)
    ...
    def post_add_new_user_negative_test_three(self):
        general_obj = SearchMovies()
        status_code, response_json = general_obj.post_user(url_list_of_cities, {}, headers_with_apikey)
        print(status_code)
        self.assertEqual(status_code, 400)
        print(str(response_json))
        actual_val = response_json['message']
    ...
    def post_selected_city_negative_test_two(self):
        general_obj = SearchMovies()
        status_code, response_json = general_obj.post_city(url_list_of_cities, {'city_code': "abc"},
                                                           headers_with_apikey)
        print(status_code)
        self.assertEqual(status_code, 400)
        print(str(response_json))
    ...
    def post_selected_city_negative_test_three(self):
        general_obj = SearchMovies()
        status_code, response_json = general_obj.post_city(url_list_of_cities, {'user_id': 1},
                                                           headers_with_apikey)
        print(status_code)
        self.assertEqual(status_code, 400)
        print(str(response_json))
    ...
    def get_list_of_theaters_negative_test_three(self):
        general_obj = SearchMovies()
        status_code, response_json = general_obj.get_theaters(url_list_of_theaters, {'user_id': 1},
                                                              headers_with_apikey)
        print(status_code)
        self.assertEqual(status_code, 400)
        print(str(response_json))
    ...
    def post_selected_theater_negative_test_three(self):
        general_obj = SearchMovies()
        status_code, response_json = general_obj.post_theater(url_list_of_theaters, {}, headers_with_apikey)
        print(status_code)
        self.assertEqual(status_code, 400)
        print(str(response_json))
        actual_val = response_json['message']
    ...
    def get_list_of_movies_negative_test_three(self):
        general_obj = SearchMovies()
        status_code, response_json = general_obj.get_movies(url_list_of_movies, {}, headers_with_apikey)
        print(status_code)
        self.assertEqual(status_code, 400)
        print(str(response_json))
        actual_val = response_json['message']
    ...
    def post_selected_movie_negative_test_two(self):
        general_obj = SearchMovies()
        status_code, response_json = general_obj.post_movie(url_list_of_movies,
                                                            {'user_id': 1},
                                                            headers_with_apikey)
    ...
    def post_selected_movie_negative_test_three(self):
        general_obj = SearchMovies()
        status_code, response_json = general_obj.post_movie(url_list_of_movies, {}, headers_with_apikey)
        print(status_code)
        self.assertEqual(status_code, 400)
        print(str(response_json))
        actual_val = response_json['message']
